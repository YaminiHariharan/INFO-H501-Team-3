...
**Data Bias:** The Yelp dataset reflects the behavior of Yelp's user base, 
which skews toward wealthier, more digitally active demographics. Restaurants 
in lower-income or minority neighborhoods tend to have fewer reviews, causing 
the Bayesian score to underrank them even when their actual star rating is 
high.
...
- Consider stratifying the Bayesian score by neighborhood rather than globally
- Regularly audit recommendation outputs for demographic and geographic 
  coverage gaps
